...
##################################################################################################
        ...
        def getTargetYDegrees():
            m_focalLength = (240 / 2) / math.tan(math.radians(39.71 / 2))
        ...
        def getTargetXDegrees():
            m_focalLength = (320 / 2) / math.tan(math.radians(50.23 / 2))
            ...
            if(get_orientation(newContours[0]) == 1 or get_orientation(newContours[1]) == 2):
                if(getXcoord(newContours[0]) < getXcoord(newContours[1])):
                    ...
                    toSend = ("/" + str(contourNum) +
                        ...
                        "/" + str(round(120 - getTwoContourCenter(left_contour, right_contour)[1], 2)) +
                        "/" + str(round(getDistance(), 2)) + 
                        "/" + str(round(getRobotAngleToTurn(), 2)) +
                        "/" + str(round(getTargetXDegrees(), 2)) +
                        "/" + str(round(getTargetYDegrees(), 2)))
